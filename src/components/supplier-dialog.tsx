...
import { useCreateSupplierMutation } from '../features/suppliers/queries';
...
/**
 * Create a supplier. In src/components/ because two hosts render it: the supplier picker on a wide
 * shell and the sheet route on a narrow one.
 */
export function SupplierDialog({ merchantId, inSheet, onDismiss, onCreated }: Props) {
