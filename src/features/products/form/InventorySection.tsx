...
import { UNIT_META } from '../schema';
import type { ProductFormValues } from '../schema';
import { DateField, Field, FieldGrid, GroupHeading, NoteCallout, SelectField, TextField, ToggleField, UNIT_OPTIONS } from './fields';

export function InventorySection({ merchantId }: { merchantId: string }) {
  ...
  return (
    <FieldGrid>
      <SelectField name="uom" label="Unit of measure" required options={UNIT_OPTIONS} placeholder="Select unit" />
      ...
      <SelectField name="purchaseUnit" label="Bought in" options={UNIT_OPTIONS} clearable placeholder="Same as unit" />
      <SelectField name="usageUnit" label="Used in" options={UNIT_OPTIONS} clearable placeholder="Same as unit" />
      <TextField
