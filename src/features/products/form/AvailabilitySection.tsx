...
import { DURATION_MODE_LABELS, UNIT_META, WEEKDAYS, durationMode } from '../schema';
import type { MeasureUnit, ProductFormValues } from '../schema';
import {
  DateField,
  DateListField,
  DateTimeInput,
...
/**
 * The weekly hours editor (docs/visual-language.md §5): one row per weekday, a switch for open, and
...
const styles = StyleSheet.create({
  week: { gap: 0 },
  day: { flexDirection: 'row', flexWrap: 'wrap', alignItems: 'center', columnGap: 12, rowGap: 6, paddingVertical: 6, borderBottomWidth: 1 },
  dayHead: { flexDirection: 'row', alignItems: 'center', gap: 10, flexBasis: '100%' },
  dayHeadWide: { flexBasis: 'auto', width: 160 },
  dayName: { minWidth: 36 },
  times: { flexDirection: 'row', alignItems: 'center', gap: 8, flexBasis: '100%' },
